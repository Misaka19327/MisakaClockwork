...
class LaravelHttpClientDataSource extends DataSource
{
    ...
    {
        $this->dispatcher->listen(ConnectionFailed::class, function ($event) {
            $this->connectionFailed($event);
        });
        $this->dispatcher->listen(RequestSending::class, function ($event) {
            $this->sendingRequest($event);
        });
        $this->dispatcher->listen(ResponseReceived::class, function ($event) {
